...
function AppLayout() {
    ...
    const link = (
      ...
      >
        <span className="relative flex items-center">
          ...
          {badge > 0 && (
            <span className={`absolute -top-2 -right-2 min-w-[16px] h-4 px-1 rounded-full bg-red-500 text-white text-[10px] font-bold flex items-center justify-center ${collapsed ? "" : ""}`}>
              {badge > 9 ? "9+" : badge}
            </span>
          )}
        </span>
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-50/70">
      ...
      >
        <div className={`h-16 flex items-center border-b ${sidebarOpen ? "px-5" : "justify-center px-2"}`}>
