...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Banyamulenge Community Heritage" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Banyamulenge Community Heritage" },
      {
        ...
        content: "Preserve heritage, connect the diaspora, and celebrate Banyamulenge culture.",
      },
      ...
      { name: "apple-mobile-web-app-title", content: "Banyamulenge" },
    ],
